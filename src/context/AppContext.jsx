...
export const AppProvider = ({ children }) => {
  ...
  const preInfoClient = {
    ...
    beAgent: {
      description: `Las denuncias serán recibidas por un tercero, quien recibirá los informes e iniciará su investigación.\nRecuerda que tu denuncia puede ser anónima, pero debe de estar basada en la buena fe.
        El uso adecuado de esta plataforma o de la línea telefónica es responsabilidad personal de cada uno de los denunciantes, el uso indebido de la misma o proporcionar información falsa constituye una falta grave y existirán consecuencias para quien sea sorprendido en alguno de estos actos.`
    }
  }
